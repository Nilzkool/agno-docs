...
| ---------------- | -------------------------- | ------------------------- | -------------------------------------------------------------------------- |
| `id`             | `str`                      | `"embed-english-v3.0"`  | The model ID used for generating embeddings.                               |
| `input_type`     | `str`                      | `"search_query"`        | The type of input to embed. See Cohere docs for `input_type` options.      |
| `embedding_types`| `Optional[List[str]]`      | -                         | The types of embeddings to generate. Optional.                              |
