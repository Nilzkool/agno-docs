...
| ----------------------------- | ------------------ | ------------------------------------------- | ------------------------------------------------------------ |
| `dimensions`                  | `int`              | `1536`                                      | The dimensionality of the generated embeddings               |
| `model`                       | `str`              | `sentence-transformers/all-MiniLM-L6-v2`   | The name of the SentenceTransformers model to use            |
