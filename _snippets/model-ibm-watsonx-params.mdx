...
| request_params  | Dict[str, Any]       | `None`                                        | Additional parameters for the request (e.g., overriding penalties, streaming options)            |
...
| client_params   | Dict[str, Any]       | `None`                                        | Additional parameters to pass to the WatsonX client                                               |