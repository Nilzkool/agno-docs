...
| request_params  | Dict[str, Any]     | `None`                                   | Additional parameters to include in the request payload                      |
...
| client_params   | Dict[str, Any]     | `None`                                   | Additional parameters passed to the client credentials initialization         |