...
| request_params   | Dict[str, Any]     | `None`                                     | Additional request parameters to include in the API call         |
...
| client_params    | Dict[str, Any]     | `None`                                     | Additional parameters to pass to the underlying client           |