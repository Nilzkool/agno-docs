...
| `async_connection`  | `Optional[lancedb.AsyncConnection]` | `None`                                      | Pre-configured LanceDB asynchronous connection                            |
| `async_table`       | `Optional[lancedb.db.AsyncTable]`   | `None`                                      | Pre-configured LanceDB asynchronous table instance                         |
...
| `on_bad_vectors`    | `Optional[str]`                     | `None`                                      | What to do on bad vectors: "error", "drop", "fill", or "null"      |
| `fill_value`        | `Optional[float]`                   | `None`                                      | Value to fill vector with if `on_bad_vectors` is "fill"                 |