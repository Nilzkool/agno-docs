...
| `on_bad_vectors`| `Optional[str]`                     | `None`       | Behavior when bad vectors encountered ("error", "drop", "fill", "null")               |
| `fill_value`    | `Optional[float]`                   | `None`       | Value to fill vector with when `on_bad_vectors` is "fill"                                  |