...
| `response_modalities` | `Optional[list[str]]` | `None` | "Text" and/or "Image" modalities for the response. |
| `speech_config` | `Optional[dict[str, Any]]` | `None` | Configuration for speech response. |
| `cached_content` | `Optional[Any]` | `None` | Cached content to be used for the model. |
