...
| `task`          | `str`        | Task assigned to the member|
...
| `agentic`  | `str`  | Retrieve memories using agentic search (semantic retrieval)       |
...
| Parameter            | Type                       | Description                                    | Default |
|----------------------|----------------------------|------------------------------------------------|---------|
| `classifier`         | `Optional[MemoryClassifier]`| Classifier for deciding memory importance      | `None`  |
...
| `system_message`            | `Optional[str]`            | Custom system message for the memory manager                   | `None`  |
| `memory_capture_instructions`| `Optional[str]`           | Custom memory capture instructions for the memory manager      | `None`  |
| `additional_instructions`   | `Optional[str]`            | Additional instructions for the memory manager                 | `None`  |
| `memories_updated`          | `bool`                     | Whether memories were updated in the last run                  | `False` |
