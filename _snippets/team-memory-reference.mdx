...
| `retrieval`                      | `MemoryRetrieval`               | `MemoryRetrieval.last_n`            | Memory retrieval strategy (e.g., `last_n`, `first_n`, `agentic`) |
...
| `updating_memory`                 | `bool`                          | `False`                             | Whether memory is currently being updated                |
...
| `agentic`   | `str`  | Retrieve memories based on agentic (semantic) search |
...
| `additional_instructions`         | `Optional[str]`       | Additional instructions for the manager                          | `None`  |
| `memories_updated`                | `bool`                | Indicates if memories were updated in the last run               | `False` |
