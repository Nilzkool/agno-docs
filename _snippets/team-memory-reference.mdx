...
The following helper methods have been added to enhance the functionality of TeamMemory:

- `get_team_context_images()`: Returns a list of `ImageArtifact` objects extracted from team member interactions that include image responses.
- `get_team_context_videos()`: Returns a list of `VideoArtifact` objects extracted from team member interactions that include video responses.
- `get_team_context_audio()`: Returns a list of `AudioArtifact` objects extracted from team member interactions that include audio responses.
