...
| `system_message`            | `Optional[str]`    | Custom system message for memory manager       | `None`  |
| `memory_capture_instructions`| `Optional[str]`   | Instructions for capturing memories            | `None`  |
| `additional_instructions`   | `Optional[str]`    | Additional instructions for memory manager     | `None`  |