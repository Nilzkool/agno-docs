...
| `existing_memories` | `Optional[List[Memory]]` | List of existing memories to compare against| `None`  |
...
| `additional_instructions`  | `Optional[str]`         | Additional instructions appended to system prompt   | `None`  |