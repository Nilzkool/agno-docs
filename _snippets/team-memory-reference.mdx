...
| `updating_memory` | `bool` | `False` | True when memory is being updated |
...
| `created_at` | `datetime` | Timestamp of memory creation | Required |
| `last_updated` | `datetime` | Timestamp of last memory update | Required |
| `metadata` | `Optional[Dict[str, Any]]` | Additional metadata for the memory | `None` |
