...
| ------------------------- | ----------------------------- | ------------------- | ---------------------------------------------------------------------------- |
| `id`                      | `str`                         | `"gpt-4o"`          | The specific model ID used for generating responses. This field is required. |
| `name`                    | `str`                         | `"AzureAIFoundry"`  | The name identifier for the agent.                                           |
| `provider`                | `str`                         | `"Azure"`           | The provider of the model.                                                   |
| `api_key`                 | `Optional[str]`               | `None`              | The API key for authenticating requests to the Azure AI Foundry service.     |
| `api_version`             | `Optional[str]`               | `"2024-05-01-preview"` | The version of the Azure AI Foundry API to use.                              |
| `azure_endpoint`          | `Optional[str]`               | `None`              | The endpoint URL for the Azure AI Foundry service.                           |
| `client`                  | `Optional[ChatCompletionsClient]` | `None`              | The client for making requests to the Azure AI Foundry service.              |
| `async_client`            | `Optional[AsyncChatCompletionsClient]` | `None`              | The asynchronous client for making requests to the Azure AI Foundry service. |
...
| `structured_outputs`      | `bool`                        | `False`             | Whether to use model-enforced structured outputs.                            |
| `response_format`         | `Optional[Union[Type[BaseModel], Dict[str, Any]]]` | `None` | Format of the response. Use a Pydantic `BaseModel` for structured outputs. |
