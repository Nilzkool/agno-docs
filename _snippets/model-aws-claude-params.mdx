---
title: AWS Anthropic Claude Parameters
---
...
| `aws_access_key`    | `Optional[str]`                         | `None`                                          | AWS access key to use.                                                                            |
| `aws_secret_key`    | `Optional[str]`                         | `None`                                          | AWS secret key to use.                                                                            |
...
| `top_k`             | `Optional[int]`                         | `None`                                          | The number of highest-probability tokens to keep when using top-k filtering.                     |
...
| `client_params`     | `Optional[Dict[str, Any]]`              | `None`                                          | Additional client parameters for initializing the Anthropic Bedrock client, provided as a dict.   |