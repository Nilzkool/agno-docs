...
A jupyter notebook is a must have for AI development and your `ai-app` comes with a notebook pre-installed with the required dependencies. To start your notebook, simply use the Docker workspace group for Jupyter:
