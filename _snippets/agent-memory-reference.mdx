...
| `memory_capture_instructions`| `Optional[str]`       | Instructions for capturing memories, override default criteria    | `None`  |
...
| `additional_instructions`| `Optional[str]`       | Additional instructions added to the end of the prompt| `None`  |