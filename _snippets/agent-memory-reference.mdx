...
| `get_user_memory`        | Gets a specific memory                                   | `memory_id: str, user_id: Optional[str] = None`                                                                                          | `UserMemory`           |
| `add_user_memory`        | Adds a new memory and returns the memory id              | `memory: UserMemory, user_id: Optional[str] = None`                                                                                      | `str`                  |
| `replace_user_memory`    | Updates an existing memory and returns the memory id     | `memory_id: str, memory: UserMemory, user_id: Optional[str] = None`                                                                      | `str`                  |
| `delete_user_memory`     | Deletes a memory                                         | `memory_id: str, user_id: Optional[str] = None`                                                                                          | `None`                 |
...
| `acreate_user_memories`  | Creates memories asynchronously from messages            | `message: Optional[str] = None, messages: Optional[List[Message]] = None, user_id: Optional[str] = None`                                 | `str`                  |
...
| `acreate_session_summary`    | Creates a summary asynchronously for a session from the stored session runs | `session_id: str, user_id: Optional[str] = None`|
...
| `memory_capture_instructions`| `Optional[str]`           | Custom instructions defining criteria for which memories to capture            | `None`  |
