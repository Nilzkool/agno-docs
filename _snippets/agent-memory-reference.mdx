...
| `memory_capture_instructions`  | `Optional[str]`           | Custom instructions for memory capture prompt | `None`  |
...
| `replace_user_memory`   | Updates an existing memory and returns its ID  | `memory_id: str, memory: UserMemory, user_id: Optional[str] = None`                                                                                  | `Optional[str]`    |
...
| `memory_capture_instructions` | `Optional[str]`         | Custom instructions for memory capture in the system message         | `None`  |
