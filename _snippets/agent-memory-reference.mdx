...
| `delete_memories` | `bool` | Whether the memory manager should delete memories | `False` |
| `clear_memories` | `bool` | Whether the memory manager should clear all memories | `False` |
