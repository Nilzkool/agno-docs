...
|-------------------------|---------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|---------------------|
| `get_user_memories`     | Retrieves all memories for a user                       | `user_id: Optional[str] = None`                                                                              | `List[UserMemory]`  |
| `get_user_memory`       | Gets a specific memory                                  | `memory_id: str, user_id: Optional[str] = None`                                                              | `Optional[UserMemory]` |
...
|-----------------------------|-----------------------------------------------------------------------|------------------------------------------|
| `get_session_summaries`     | Retrieves all session summaries for a user                            | `user_id: Optional[str] = None`          |
...
| `memory_capture_instructions`| `Optional[str]`           | Custom instructions for memory capture criteria            | `None`  |
