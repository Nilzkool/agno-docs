...
| `reasoning_effort` | `Optional[str]` | `None` | The effort level for reasoning, impacting response quality and token usage. |
...
| `audio` | `Optional[Dict[str, Any]]` | `None` | Audio-specific parameters for the model, such as voice and format. |
...
| `structured_outputs` | `bool` | `True` | Whether to use the structured outputs from the Model. |
