...
| `on_bad_vectors` | `Optional[str]`  | -       | Action for bad vectors: "error", "drop", "fill", or "null".                                                     |
| `fill_value`     | `Optional[float]`| -       | Value to fill the vector with if `on_bad_vectors` is set to "fill".                                                  |