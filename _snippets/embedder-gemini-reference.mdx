...
| `request_params`| `Optional[Dict]` | Additional parameters for embedding requests      | `None`                                  |
| `client_params` | `Optional[Dict]` | Additional parameters for client initialization   | `None`                                  |
