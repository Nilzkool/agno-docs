...
| `max_pool_size`         | `int`                    | `100`                          | Maximum number of connections in the MongoDB connection pool           |
...
| `search_index_name`     | `Optional[str]`          | `"vector_index_1"`           | Name of the Atlas Search index                                         |
| `kwargs`                | `dict`                   | `{}`                           | Additional keyword arguments for MongoClient                           |