...
| `embedder`           | `Optional[Embedder]`             | `None`     | Embedder for creating embeddings (defaults to OpenAIEmbedder)     |
...
| `pool_threads`       | `Optional[int]`                  | `1`        | Number of threads to use for the Pinecone client                  |
