...
- **User Memories:**
  ...
  - **Now:**
    ...
    memory = Memory()
    agent = Agent(enable_user_memories=True, memory=memory)
    # or for a team:
    team = Team(enable_user_memories=True, memory=memory)
    ```
...
- **Session Summaries:**
  ...
  - **Now:**
    ...
    memory = Memory()
    agent = Agent(enable_session_summaries=True, memory=memory)
    # or for a team:
    team = Team(enable_session_summaries=True, memory=memory)
    ```
