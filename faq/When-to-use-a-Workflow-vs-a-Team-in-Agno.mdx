...
- Coordinating complex tasks (e.g., in `coordinate` mode)
- Collaborating to reach a consensus (e.g., in `collaborate` mode)
- Routing tasks to specialized members (e.g., in `route` mode)
