...
- `anthropic.claude-3-5-sonnet-20240620-v1:0` model is good for most use-cases and supports image input.
- `anthropic.claude-3-5-haiku-20240620-v1:0` model is their fastest model.
