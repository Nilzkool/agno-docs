...
## Example: Stopping the Agent with `StopAgentRun`

This example demonstrates how to use the `StopAgentRun` exception to immediately halt an agent's execution.

```python stop_agent_run.py
from agno.agent import Agent
