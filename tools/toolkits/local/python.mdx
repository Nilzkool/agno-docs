...
| `uv_pip_install` | `bool` | `False` | Enables `uv pip install` of required packages for faster installations.                                 |
...
- View [Cookbook](https://github.com/Nilzkool/agno/blob/main/cookbook/tools/python_tools.py)
