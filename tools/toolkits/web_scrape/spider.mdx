...
| ------------- | ----- | ------- | ---------------------------------------------- |
| `max_results` | `Optional[int]` | `None`  | The maximum number of search results to return |
| `url`         | `Optional[str]` | `None`  | The url to be scraped or crawled               |
| `optional_params` | `Optional[dict]` | `None` | Optional dictionary of parameters to pass to the Spider client. |

## Toolkit Functions

| Function | Description                           |
| -------- | ------------------------------------- |
| `search` | Searches the web for the given query. Default `max_results` is 5. |
