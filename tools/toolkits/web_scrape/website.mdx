...
| `add_website_to_combined_knowledge_base` | This function adds a websites content to a combined knowledge base. **NOTE:** The website must start with `https://` and should be a valid website. Use this function to get information about products from the internet. |
