...
| -------------------- | ----- | ------- | -------------------------------------------------------------------------- |
| `api_key`            | `str` | `None`  | The API key for authentication purposes, retrieved from the configuration. |
| `base_url`           | `str` | `"https://r.jina.ai/"`       | The base URL of the API, retrieved from the configuration.                 |
| `search_url`         | `str` | `"https://s.jina.ai/"`       | The URL used for search queries, retrieved from the configuration.         |
| `max_content_length` | `int` | `10000`       | The maximum length of content allowed, retrieved from the configuration.   |
...
- View [Cookbook](https://github.com/Nilzkool/agno/blob/main/cookbook/tools/jinareader_tools.py)
