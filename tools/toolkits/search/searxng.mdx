...
**Searxng** enables an Agent to perform web searches across various categories using a Searxng instance.
...
- View [Cookbook](https://github.com/Nilzkool/agno/blob/main/cookbook/agent_concepts/agentic_search/searxng.py)
