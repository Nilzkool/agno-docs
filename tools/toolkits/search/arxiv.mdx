...
The following agent will run search arXiv for "language models" and print the response.
...
| ---------------------------------------- | -------------------------------------------------------------------------------------------------- |
| `search_arxiv_and_return_articles`       | This function searches arXiv for a topic, adds the results to the knowledge base and returns them. |
| `read_arxiv_papers`                      | This function reads one or more arXiv papers by ID and returns extracted content.                  |
