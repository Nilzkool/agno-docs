...
`PandasTools` initializes with `**kwargs`. It exposes the following functions as tools:
...
- View [Cookbook](https://github.com/Nilzkool/agno/blob/main/cookbook/tools/pandas_tools.py)
