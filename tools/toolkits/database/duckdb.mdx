...
| `export_table_to_path`     | Save a table in a desired format (default: parquet). If the path is provided, it will be saved under that path. Otherwise in current directory.                                                                                                 |
...
- View [Tools](https://github.com/Nilzkool/agno/blob/main/libs/agno/agno/tools/duckdb.py)