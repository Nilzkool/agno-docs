...
| `send_email`             | `bool`       | `True`  | Enable sending emails immediately                          |
| `send_email_reply`       | `bool`       | `True`  | Enable sending replies to existing email threads           |
| `search_emails`          | `bool`       | `True`  | Enable searching emails using natural language queries     |
...
| `send_email_reply`     | Send a reply email to an existing thread                                  |
