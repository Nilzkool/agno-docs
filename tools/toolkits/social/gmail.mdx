...
| `get_emails_by_thread`  | `bool`  | `True`  | Enable retrieving all emails from a specific thread        |
| `create_draft_email`    | `bool`  | `True`  | Enable creating email drafts                               |
| `send_email`            | `bool`  | `True`  | Enable sending emails                                      |
| `send_email_reply`      | `bool`  | `True`  | Enable sending email replies to existing threads           |
