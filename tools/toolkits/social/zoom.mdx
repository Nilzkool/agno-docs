...
| `get_meeting`            | Get detailed information about a meeting  |
...
- View tools implementation: [zoom.py](https://github.com/Nilzkool/agno/blob/main/libs/agno/agno/tools/zoom.py)
- View unit tests: [test_zoom_tools.py](https://github.com/Nilzkool/agno/blob/main/libs/agno/tests/unit/tools/test_zoom_tools.py)
