...
- View the ZoomTools source on GitHub: [zoom.py](https://github.com/Nilzkool/agno/blob/main/libs/agno/agno/tools/zoom.py)
- Report issues or contribute: [GitHub Issues](https://github.com/Nilzkool/agno/issues)
