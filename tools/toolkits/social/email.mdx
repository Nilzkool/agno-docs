...
| ------------ | --------------------------------------------------------------------------------------------------------------------------- |
| `email_user` | Emails the user with the given subject and body. Returns **"email sent successfully"** if the email was sent successfully, or **"error: [error message]"** otherwise. |
