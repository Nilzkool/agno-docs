...
| `get_video_timestamps` | `bool`      | `True`  | Enables the functionality to retrieve video timestamps.                            |
...
| `get_video_timestamps`       | Generates timestamps for a YouTube video based on captions. |
