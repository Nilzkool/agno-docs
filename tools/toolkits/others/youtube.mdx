...
| `get_video_timestamps` | `bool`      | `True`   | Enables the functionality to generate timestamps for a YouTube video.              |
| `languages`          | `List[str]` | `["en"]` | Specifies the list of languages for which data should be retrieved, if applicable. |
...
| `get_video_timestamps`     | This function generates timestamps for a YouTube video. |
