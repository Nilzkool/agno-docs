...
| `json_data`   | `Dict[str, Any]`    | `None`  | JSON body to send with the request                         |
...
- View [Tools](https://github.com/Nilzkool/agno/blob/main/libs/agno/agno/tools/api.py)
- View [Cookbook](https://github.com/Nilzkool/agno/blob/main/cookbook/tools/custom_api_tools.py)
