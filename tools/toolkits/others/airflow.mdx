...
agent = Agent(
    tools=[AirflowTools(dags_dir="tmp/dags", save_dag=True, read_dag=True)], show_tool_calls=True, markdown=True
)
...
- View [Cookbook](https://github.com/Nilzkool/agno/blob/main/cookbook/tools/airflow_tools.py)
