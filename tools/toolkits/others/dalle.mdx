...
| --------- | ---- | ------- | ----------- |
| `model`   | `str`| `"dall-e-3"` | The DALL-E model to use (`'dall-e-3'` or `'dall-e-2'`). |
...
| `api_key` | `str`| `None`      | The OpenAI API key for authentication (defaults to `OPENAI_API_KEY`). |
...
- View [Cookbook](https://github.com/Nilzkool/agno/blob/main/cookbook/tools/dalle_tools.py)
