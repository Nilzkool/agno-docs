...
- View [Tools](https://github.com/Nilzkool/agno/blob/main/libs/agno/agno/tools/mlx_transcribe.py)
- View [Cookbook](https://github.com/Nilzkool/agno/blob/main/cookbook/tools/mlx_transcribe_tools.py)
