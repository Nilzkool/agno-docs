...
| `create_issue`             | Create a new issue within a specific project and team. Parameters include `title` (str), `description` (str), `team_id` (str), `project_id` (str), `assignee_id` (str). |
