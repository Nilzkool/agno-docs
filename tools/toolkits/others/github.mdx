...
The following example requires the `PyGithub` library and a Github access token which can be obtained from [here](https://github.com/settings/tokens).
...
The following agent will list open pull requests for the specified GitHub repository.
...
| -------------------------- | ------ | ------- | ----------------------------------------------------------------------------------------------------------- |
| `access_token`             | `str`  | `None`  | Github access token for authentication. If not provided, will use `GITHUB_ACCESS_TOKEN` env var.           |
