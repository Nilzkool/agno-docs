...
```shell
uv pip install -U openai exa_py duckduckgo-search yfinance pypdf sqlalchemy 'fastapi[standard]' youtube-transcript-api agno
```
...
```shell
python cookbook/playground/multimodal_agents.n```
