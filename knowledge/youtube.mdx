...
knowledge_base = YouTubeKnowledgeBase(
    ...
    # Table name: ai.youtube_documents
    vector_db=PgVector(
...
- View [Async loading Cookbook](https://github.com/Nilzkool/agno/blob/main/cookbook/agent_concepts/knowledge/youtube_kb_async.py)