...
Agents also have **memory**, **knowledge**, **storage**, the ability to **reason**, and can **collaborate** in **teams**.

- **Teams:** enable Agents to work together by delegating subtasks, sharing expertise, and combining responses to solve complex problems.
