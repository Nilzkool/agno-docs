...
| `citations` | `Citations` | `None` | Citations or references associated with the response, typically from a knowledge base. |
...
| `thinking` | `str` | `None` | Internal thought process or monologue of the agent. |
| `reasoning_content` | `str` | `None` | Detailed step-by-step reasoning process. |
