...
ws_settings = WorkspaceSettings(
    ...
    # subnet_ids=["subnet-xyz", "subnet-abc"], # Explicitly set subnet IDs
    # Or provide public and private subnets, which will be combined into subnet_ids if not explicitly set
    aws_public_subnets=["subnet-xyz"],
    #
    # -*- Image Settings
    #
