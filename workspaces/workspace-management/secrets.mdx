...
prd_secret = SecretsManager(
    ...
    force_delete=True, # Set to True to force deletion of the secret without recovery
...
Production resources can also read secrets using yaml files but we highly recommend using [AWS Secrets](https://docs.aws.com/secretsmanager/latest/userguide/intro.html).
