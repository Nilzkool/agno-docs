...
```python cookbook/examples/teams/route/ai_customer_support_team.py
...
<Steps>
    ...
    <Step title="Install required libraries">
        ```bash
        pip install -U openai duckduckgo-search slack_sdk exa_py pgvector 'psycopg[binary]' sqlalchemy
        ```
    </Step>
