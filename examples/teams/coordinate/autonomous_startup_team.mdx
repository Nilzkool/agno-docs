...
```python cookbook/examples/teams/coordinate/autonomous_startup_team.py
...
<Steps>
    ...
    <Step title="Install required libraries">
        ```bash
        pip install -U openai duckduckgo-search exa_py slack yfinance pgvector 'psycopg[binary]' sqlalchemy pypdf
        ```
    </Step>
