...
class HackerNewsReporter(Workflow):
    ...
    hn_agent: Agent = Agent(
        description="Get the top stories from hackernews. Share url and summary.",
...
if __name__ == "__main__":
    # Run workflow
    storage = YamlStorage(
        dir_path="tmp/workflow_sessions_yaml",
        mode="workflow",
    )
...
- View [Cookbook](https://github.com/Nilzkool/agno/blob/main/cookbook/agent_concepts/storage/yaml_storage_for_workflow.py)
