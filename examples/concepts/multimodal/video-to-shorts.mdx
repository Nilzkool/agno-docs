...
```python
"""
1. Install dependencies using: `pip install opencv-python google-geneai sqlalchemy agno`
2. Install ffmpeg: `brew install ffmpeg`
3. Run the script using: `python cookbook/agent_concepts/multimodal/video_to_shorts.py`
"""
...
<Steps>
  ...
  <Step title="Install Python dependencies">
    ```bash
    pip install opencv-python google-geneai sqlalchemy agno
    ```
  </Step>
