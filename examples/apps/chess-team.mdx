...
<video autoPlay muted controls className="w-full aspect-video" src="/videos/chess-team.mp4" />
...
### Code
The complete code is available in the Agno repository: [examples/apps/chess_team](https://github.com/Nilzkool/agno/tree/main/examples/apps/chess_team)
