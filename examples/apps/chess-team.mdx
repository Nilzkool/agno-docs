...
Chess Team is a chess application where multiple AI agents collaborate to play chess against each other, demonstrating the power of multi-agent systems in complex game environments.
...
### Code
The complete code is available in the [Agno repository](https://github.com/Nilzkool/agno/tree/main/examples/apps/chess_team).
...
<Steps>
  ...
  <Step title="Install Dependencies">
    ```bash
    pip install -r examples/apps/chess_team/requirements.txt
    ```
  </Step>
  ...
  <Step title="Launch the App">
    ```bash
    streamlit run examples/apps/chess_team/app.py
    ```
  </Step>
