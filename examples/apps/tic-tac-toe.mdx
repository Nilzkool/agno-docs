...
### Code
The complete code is available in the [Agno repository](https://github.com/Nilzkool/agno/tree/main/examples/apps/tic_tac_toe).
...
<Steps>
  ...
  <Step title="Install Dependencies">
    ```bash
    pip install -r examples/apps/tic_tac_toe/requirements.txt
    ```
  </Step>
  ...
  <Step title="Launch the App">
    ```bash
    streamlit run examples/apps/tic_tac_toe/app.py
    ```
  </Step>
