...
Place the file under `cookbook/workflows/product_manager/product_manager.py` in the repository.

Create a file `cookbook/workflows/product_manager/product_manager.py` with the following code:
...
<Steps>
  ...
  <Step title="Run the agent">
    ```bash
    python cookbook/workflows/product_manager/product_manager.py
    ```
  </Step>
