...
- "How Quantum Computing is Revolving Cybersecurity"
...
```python cookbook/workflows/blog_post_generator.py
import json
...
<Steps>
  ...
  <Step title="Install libraries">
    ```bash
    pip install -U openai duckduckgo-search newspaper4k lxml_html_clean sqlalchemy agno
    ```
  </Step>
